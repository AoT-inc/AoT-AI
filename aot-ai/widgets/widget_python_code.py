...
from aot-ai.utils.code_verification import create_python_file
from aot-ai.utils.code_verification import test_python_code
from aot-ai.utils.constraints_pass import constraints_pass_positive_value
from aot-ai.widgets.base_widget import AbstractWidget
...
class WidgetModule(AbstractWidget, threading.Thread):
    ...
    def initialize_variables(self):
        ...
        module_name = "aot-ai.widget.python_code_{}".format(os.path.basename(file_run).split('.')[0])
