...
#
#  Copyright (C) 2025 <aot-ai@aot-inc.com>
#
...
from aot-ai.config import THEMES_DARK
...
from aot-ai.aot-ai_flask.utils.utils_general import use_unit_generate
from aot-ai.utils.constraints_pass import constraints_pass_positive_value
from aot-ai.utils.influx import read_influxdb_list
from aot-ai.utils.system_pi import add_custom_measurements
from aot-ai.utils.system_pi import return_measurement_info
from aot-ai.utils.system_pi import str_is_float
...
def custom_yaxes_str_from_form(form):
    ...
    :param form: UI form submitted by aot-ai
