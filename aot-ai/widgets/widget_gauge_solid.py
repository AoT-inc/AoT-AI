...
WIDGET_INFORMATION = {
    ...
    'dependencies_module': [
        ...
        [
            ...
            '/opt/AoT-AI/aot-ai/aot-ai_flask/static/js/user_js/solid-gauge-9.1.2.js'
        ],
        [
            ...
            'cp -rf Highcharts-Stock-9.1.2/code/modules/solid-gauge.js /opt/AoT-AI/aot-ai/aot-ai_flask/static/js/user_js/solid-gauge-9.1.2.js',
            'cp -rf Highcharts-Stock-9.1.2/code/modules/solid-gauge.js.map /opt/AoT-AI/aot-ai/aot-ai_flask/static/js/user_js/solid-gauge.js.map',
            'rm -rf Highcharts-Stock-9.1.2.zip',
