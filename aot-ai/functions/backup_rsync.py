# coding=utf-8
#
#  backup_rsync.py - Periodically perform backup of AoT-AI assets to remote system using rsync
#
...
from aot-ai.config import (ALEMBIC_VERSION, AOT-AI_VERSION, PATH_CAMERAS,
...
FUNCTION_INFORMATION = {
    ...
    'custom_options': [
        ...
        },
        {
            ...
            'type': 'text',
            'default_value': '/home/pi/backup_aot-ai',
            'required': True,
...
class CustomModule(AbstractFunction):
    ...
    def backup_settings(self):
        filename = 'AoT-AI_{mver}_Settings_{aver}_{host}_{dt}.zip'.format(
    ...
    def backup_measurements(self):
        ...
        filename = 'AoT-AI_{mv}_Influxdb_{iv}_{host}_{dt}.zip'.format(
            mv=AOT-AI_VERSION, iv=influxd_version,
            host=socket.gethostname().replace(' ', ''),
            dt=datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))
