...
FUNCTION_INFORMATION = {
    ...
    'dependencies_module': [
        ...
        # used elsewhere in AoT-AI. All need to be set to the same version in order to prevent conflicts.
    ],
...
class CustomModule(AbstractFunction):
    ...
    def loop(self):
        ...
        try:
            # This log line will appear in the Daemon log under Config -> AoT-AI Logs
