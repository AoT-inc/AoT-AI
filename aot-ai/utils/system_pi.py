...
from aot-ai.config_devices_units import UNIT_CONVERSIONS
...
logger = logging.getLogger("aot-ai.system_pi")
...
def cmd_output(command, stdout_pipe=True, shell=True, timeout=360, user='aot-ai', cwd='/home'):
    """
...
def can_perform_backup():
    ...
    """
    free_before = get_directory_free_space('/var/AoT-AI-backups')
