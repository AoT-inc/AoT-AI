...
logger = logging.getLogger("aot-ai.notification")
...
def send_email(smtp_host, smtp_protocol, smtp_port, smtp_user, smtp_pass,
    ...
    try:
        ...
        outer = MIMEMultipart()
        if not subject:
            subject = "AoT-AI Notification ({})".format(
                socket.gethostname())
        ...
        # msg['Subject'] = "AoT-AI Notification ({})".format(
        #     socket.gethostname())
        ...
        #     set_user_grp(out_filename, 'aot-ai', 'aot-ai')
