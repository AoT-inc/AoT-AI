...
logger = logging.getLogger("aot-ai.utils.widget_generate_html")
...
def assure_path_exists(path):
    ...
    if not os.path.exists(path):
        os.makedirs(path)
        os.chmod(path, 0o774)
        set_user_grp(path, 'aot-ai', 'aot-ai')
    return path
    ...
    for widget_name in dict_widgets:
        try:
            ...
            with open(path_head, 'w') as fw:
                ...
                fw.write(html_head)
                fw.close()
            set_user_grp(path_head, 'aot-ai', 'aot-ai')
            ...
            with open(path_title_bar, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_title_bar, 'aot-ai', 'aot-ai')
            ...
            with open(path_body, 'w') as fw:
                ...
                fw.write(html_body)
                fw.close()
            set_user_grp(path_body, 'aot-ai', 'aot-ai')
            ...
            with open(path_configure_options, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_configure_options, 'aot-ai', 'aot-ai')
            ...
            with open(path_js, 'w') as fw:
                ...
                fw.write(html_js)
                fw.close()
            set_user_grp(path_js, 'aot-ai', 'aot-ai')
            ...
            with open(path_js_ready, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_js_ready, 'aot-ai', 'aot-ai')
            ...
            with open(path_js_ready_end, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_js_ready_end, 'aot-ai', 'aot-ai')
