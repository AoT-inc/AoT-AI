...
from aot-ai.config import PATH_ACTIONS
...
from aot-ai.utils.influx import get_last_measurement
from aot-ai.utils.influx import get_past_measurements
from aot-ai.utils.modules import load_module_from_file
from aot-ai.utils.system_pi import return_measurement_info

logger = logging.getLogger("aot-ai.actions")
...
def trigger_action(
    ...
    logger_actions = logging.getLogger("aot-ai.trigger_action_{id}".format(
...
def trigger_controller_actions(dict_actions, controller_id, message='', debug=False):
    ...
    :return:
    """
    logger_actions = logging.getLogger("aot-ai.trigger_controller_actions_{id}".format(
