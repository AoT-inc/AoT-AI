...
from aot-ai.config import (CAMERA_INFO, DEPENDENCIES_GENERAL,
                           DEPENDENCY_LOG_FILE, FUNCTION_INFO,
                           INSTALL_DIRECTORY, METHOD_INFO)
from aot-ai.databases.models import (Actions, Camera, Conditional,
...
logger = logging.getLogger("aot-ai.update_dependencies")
    ...
    if dependencies:
        for each_dep in dependencies:
            ...
            if each_dep[2] == 'bash-commands':
                ...
                install_cmd = f"{INSTALL_DIRECTORY}/aot-ai/scripts/dependencies.sh {each_dep[1]}"
