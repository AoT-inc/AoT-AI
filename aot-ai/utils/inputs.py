...
from aot-ai.config import PATH_INPUTS
from aot-ai.config import PATH_INPUTS_CUSTOM
from aot-ai.inputs.sensorutils import convert_units
from aot-ai.utils.modules import load_module_from_file

logger = logging.getLogger("aot-ai.utils.inputs")
...
def list_devices_using_interface(interface):
    ...
    :param interface: string, can be 'GPIO', 'I2C', 'UART', 'BT', '1WIRE', 'AoT-AI', 'RPi'
