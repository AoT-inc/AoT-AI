...
# -*- coding: utf-8 -*-
#
#  aot-ai_client.py - Client to communicate with the AoT-AI daemon.
#
...
from aot-ai.config import PYRO_URI
from aot-ai.databases.models import SMTP, Misc
from aot-ai.utils.database import db_retrieve_table_daemon
from aot-ai.utils.send_data import send_email as send_email_notification
...
def parseargs(parser):
    ...
    parser.add_argument('--ramuse', action='store_true',
                        help="Return the amount of ram used by the AoT-AI daemon")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Client for AoT-AI daemon.")
