...
from aot-ai.aot-ai_flask.utils.utils_general import generate_form_input_list
from aot-ai.utils.inputs import parse_input_information

logger = logging.getLogger("aot-ai.forms_input")
...
class InputAdd(FlaskForm):
    ...
    for each_input in list_inputs_sorted:
        ...
        if 'input_manufacturer' in dict_inputs[each_input] and dict_inputs[each_input]['input_manufacturer']:
            ...
            if dict_inputs[each_input]['input_manufacturer'] == "AoT-AI":
                is_aot-ai = True
        else:
            name = dict_inputs[each_input]['input_name']
