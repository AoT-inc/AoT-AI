...
from aot-ai.config import INSTALL_DIRECTORY, PATH_1WIRE
...
from aot-ai.aot-ai_flask.forms import forms_action, forms_input
from aot-ai.aot-ai_flask.routes_static import inject_variables
from aot-ai.aot-ai_flask.utils import utils_action, utils_general, utils_input
...
logger = logging.getLogger('aot-ai.aot-ai_flask.routes_input')
...
def page_input():
    ...
    input_path = os.path.join(
        INSTALL_DIRECTORY,
        'aot-ai/aot-ai_flask/templates/pages/data_options/input_options')
    ...
    if not current_app.config['TESTING']:
        for each_input_dev in input_dev:
            if each_input_dev.interface == "FTDI":
                from aot-ai.devices.atlas_scientific_ftdi import \
