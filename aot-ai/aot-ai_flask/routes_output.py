...
from aot-ai.aot-ai_flask.forms import forms_output
from aot-ai.aot-ai_flask.routes_static import inject_variables
from aot-ai.aot-ai_flask.utils import utils_general, utils_output
...
logger = logging.getLogger('aot-ai.aot-ai_flask.routes_output')
...
def page_output():
    ...
    output_path = os.path.join(
        INSTALL_DIRECTORY,
        'aot-ai/aot-ai_flask/templates/pages/output_options')
