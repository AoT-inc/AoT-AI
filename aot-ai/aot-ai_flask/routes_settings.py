...
from aot-ai.config import (PATH_ACTIONS_CUSTOM, PATH_FUNCTIONS_CUSTOM,
                           PATH_INPUTS_CUSTOM, PATH_OUTPUTS_CUSTOM,
                           PATH_WIDGETS_CUSTOM, THEMES, USAGE_REPORTS_PATH)
from aot-ai.databases.models import (SMTP, Conversion, Measurement, Misc, Role,
                                     Unit, User)
from aot-ai.aot-ai_flask.forms import forms_settings
from aot-ai.aot-ai_flask.routes_static import inject_variables
from aot-ai.aot-ai_flask.utils import utils_general, utils_settings
...
logger = logging.getLogger('aot-ai.aot-ai_flask.settings')
