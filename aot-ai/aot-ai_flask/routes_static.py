...
from aot-ai.config import (ALEMBIC_VERSION, INSTALL_DIRECTORY, LANGUAGES,
                           AOT-AI_VERSION, THEMES, THEMES_DARK)
from aot-ai.config import PATH_STATIC
from aot-ai.config_translations import TRANSLATIONS
from aot-ai.databases.models import Dashboard, Misc
from aot-ai.aot-ai_client import DaemonControl
from aot-ai.aot-ai_flask.forms import forms_dashboard
from aot-ai.aot-ai_flask.routes_authentication import admin_exists
from aot-ai.aot-ai_flask.utils.utils_general import user_has_permission
...
def template_exists(path):
    path_start = "{}/aot-ai/aot-ai_flask/templates".format(INSTALL_DIRECTORY)
...
# @blueprint.route("/aot-ai-manual_{}.pdf".format(AOT-AI_VERSION))
# def download_pdf_manual():
#     """Return PDF Manual."""
#     path_manual = os.path.join(INSTALL_DIRECTORY, "docs")
#     return send_from_directory(path_manual, "aot-ai-manual.pdf")
