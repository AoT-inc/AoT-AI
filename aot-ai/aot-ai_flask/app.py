# coding=utf-8
#
#  app.py - Flask web server for AoT-AI
#
import base64
import logging
import os
...
from aot-ai.config import INSTALL_DIRECTORY, LANGUAGES, ProdConfig
from aot-ai.databases.models import Misc, User, Widget, populate_db
from aot-ai.databases.utils import session_scope
from aot-ai.aot-ai_flask import (routes_admin, routes_authentication,
...
from aot-ai.aot-ai_flask.api import api_blueprint, init_api
...
def extension_babel(app):
    def get_locale():
        ...
        # Check for the presence of AoT-AI/.language with a language
        try:
...
def extension_session(app):
    # TODO: Remove this code if AoT-AI doesn't produce this issue anymore
    ...
    #     import shutil
    #     shutil.rmtree('/opt/AoT-AI/aot-ai/flask_session')
    # except:
    #     pass
