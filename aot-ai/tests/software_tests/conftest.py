...
from aot-ai.aot-ai_flask.app import create_app
from aot-ai.config import TestConfig
from webtest import TestApp
from aot-ai.aot-ai_flask.extensions import db as _db
...
from aot-ai.databases.models import populate_db
...
def login_user(app, username, password):
    ...
    form['aot-ai_username'] = username
    form['aot-ai_password'] = password
