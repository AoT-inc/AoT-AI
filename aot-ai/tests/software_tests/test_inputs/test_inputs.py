...
from aot-ai.inputs.am2315 import InputModule as AM2315Sensor
from aot-ai.inputs.atlas_ph import InputModule as AtlaspHSensor
from aot-ai.inputs.atlas_pt1000 import InputModule as AtlasPT1000Sensor
from aot-ai.inputs.bh1750 import InputModule as BH1750Sensor
from aot-ai.inputs.bme280 import InputModule as BME280Sensor
from aot-ai.inputs.bmp180 import InputModule as BMP180Sensor
from aot-ai.inputs.bmp280 import InputModule as BMP280Sensor
from aot-ai.inputs.chirp import InputModule as ChirpSensor
from aot-ai.inputs.dht11 import InputModule as DHT11Sensor
from aot-ai.inputs.dht22 import InputModule as DHT22Sensor
from aot-ai.inputs.ds18b20 import InputModule as DS18B20Sensor
from aot-ai.inputs.htu21d import InputModule as HTU21DSensor
from aot-ai.inputs.ina219x import InputModule as INA219xSensor
from aot-ai.inputs.k30 import InputModule as K30Sensor
from aot-ai.inputs.linux_command import InputModule as LinuxCommand
from aot-ai.inputs.mh_z16 import InputModule as MHZ16Sensor
from aot-ai.inputs.mh_z19 import InputModule as MHZ19Sensor
from aot-ai.inputs.aot-ai_ram import InputModule as AoT-AIRam
from aot-ai.inputs.rpi_cpu_gpu_temperature import \
    InputModule as RaspberryPiCPUTemp
from aot-ai.inputs.rpi_signal_pwm import InputModule as SignalPWMInput
from aot-ai.inputs.rpi_signal_revolutions import InputModule as SignalRPMInput
from aot-ai.inputs.sht1x_7x import InputModule as SHT1x7xSensor
from aot-ai.inputs.sht2x import InputModule as SHT2xSensor
from aot-ai.inputs.system_cpuload import InputModule as RaspberryPiCPULoad
from aot-ai.inputs.system_freespace import InputModule as RaspberryPiFreeSpace
from aot-ai.inputs.tmp006 import InputModule as TMP006Sensor
from aot-ai.inputs.tsl2561 import InputModule as TSL2561Sensor
from aot-ai.inputs.tsl2591_sensor import InputModule as TSL2591Sensor
from aot-ai.inputs.ttn_data_storage import InputModule as TTNDataStorage
...
def test__iter__returns_iterator():
    ...
    for index, each_class in enumerate(input_classes):
        ...
        with mock.patch('aot-ai.inputs.{fn}.InputModule.get_measurement'.format(fn=filename)) as mock_measure:
...
def test_raises_exception():
    ...
    for index, each_class in enumerate(input_classes):
        ...
        with mock.patch('aot-ai.inputs.{fn}.InputModule.get_measurement'.format(fn=filename), side_effect=IOError):
...
def test_read_returns_1_on_exception():
    ...
    for index, each_class in enumerate(input_classes):
        ...
        with mock.patch('aot-ai.inputs.{fn}.InputModule.get_measurement'.format(fn=filename), side_effect=Exception):
    ...
    with LogCapture() as log_cap:
        for index, each_class in enumerate(input_classes):
            ...
            print("test_read_logs_unknown_errors: Testing Input ({}/{}): {}".format(
                index + 1, len(input_classes), filename))
            with mock.patch('aot-ai.inputs.{fn}.InputModule.get_measurement'.format(fn=filename), side_effect=Exception('msg')):
                each_class.read()
            expected_logs = ('aot-ai.inputs.{fn}'.format(fn=filename),
                             'ERROR',
