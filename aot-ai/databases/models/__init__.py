...
from aot-ai.config import ALEMBIC_VERSION
from aot-ai.config import INSTALL_DIRECTORY
from aot-ai.config import USER_ROLES
...
def alembic_upgrade_db():
    ...
    def upgrade_alembic():
        ...
        command = '/bin/bash {path}/aot-ai/scripts/upgrade_commands.sh update-alembic'.format(path=INSTALL_DIRECTORY)
