# coding=utf-8
#
# remote_output_on_off.py - Output for controlling a remote AoT-AI On/Off Output
#
import json
import time
...
OUTPUT_INFORMATION = {
    ...
    'output_name': "{} AoT-AI Output: {}".format(lazy_gettext('Remote'), lazy_gettext('On/Off')),
    'measurements_dict': measurements_dict,
    'channels_dict': channels_dict,
    'output_library': 'requests',
    'output_types': ['on_off'],

    'message': 'This Output allows remote control of another AoT-AI On/Off Output over a network using the API.',
