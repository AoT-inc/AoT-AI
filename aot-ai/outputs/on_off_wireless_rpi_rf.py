...
from aot-ai.utils.constraints_pass import constraints_pass_positive_or_zero_value
...
OUTPUT_INFORMATION = {
    ...
    'message': 'This output uses a 315 or 433 MHz transmitter to turn wireless power outlets on or off. '
               'Run /opt/AoT-AI/aot-ai/devices/wireless_rpi_rf.py with a receiver to discover the codes '
    ...
    'custom_channel_options': [
        ...
        },
        {
            ...
            'phrase': lazy_gettext('Set the state when AoT-AI starts')
        },
        {
            'id': 'state_shutdown',
            'type': 'select',
            ...
            'phrase': lazy_gettext('Set the state when AoT-AI shuts down')
        },
        {
...
class OutputModule(AbstractOutput):
    ...
    def initialize(self):
        from aot-ai.devices.wireless_rpi_rf import Transmit433MHz
