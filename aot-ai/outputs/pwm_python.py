...
self.logger.info(log_string)""",
        ...
        },
        {
            ...
            'phrase': 'The value when AoT-AI starts'
        },
        {
            'id': 'state_shutdown',
            'type': 'select',
        ...
        },
        {
            ...
            'phrase': 'The value when AoT-AI shuts down'
        },
        {
...
class OutputModule(AbstractOutput):
    ...
    def initialize(self):
        ...
        try:
            ...
            module_name = "aot-ai.output.{}".format(os.path.basename(file_run).split('.')[0])
