...
ACTION_INFORMATION = {
    ...
    'usage': 'Executing <strong>self.run_action("ACTION_ID")</strong> will execute the bash command.'
             'Executing <strong>self.run_action("ACTION_ID", value={"user": "aot-ai", "command": "/home/pi/my_script.sh on"})</strong> will execute the action with the specified command and user.',
