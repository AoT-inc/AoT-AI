...
measurements_dict = {
    ...
    2: {
        'measurement': 'disk_space',
        'unit': 'MB',
        'name': 'AoT-AI Backend RAM Used'
    },
    3: {
        'measurement': 'disk_space',
        'unit': 'MB',
        'name': 'AoT-AI Frontend RAM Used'
    }
}

# Input information
INPUT_INFORMATION = {
    'input_name': 'System and AoT-AI RAM',
    'input_name_unique': 'AOT-AI_RAM',
    ...
    'custom_options': [
        {
            ...
            'required': False,
            'name': 'AoT-AI Frontend RAM Endpoint',
            'phrase': 'The endpoint to get AoT-AI frontend ram usage'
        }
    ]
}
