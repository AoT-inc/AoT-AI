...
INPUT_INFORMATION = {
    ...
    'dependencies_module': [
        ...
        ('bash-commands',
         [
             '/opt/AoT-AI/env/RTIMULib_installed',
         ],
         [
             'cd /tmp',
             'git clone https://github.com/RPi-Distro/RTIMULib',
             'cd ./RTIMULib/Linux/python/',
             '/opt/AoT-AI/env/bin/python setup.py build',
             '/opt/AoT-AI/env/bin/python setup.py install',
             'touch /opt/AoT-AI/env/RTIMULib_installed'
         ]),
