...
from aot-ai.abstract_base_controller import AbstractBaseController
    ...
    def value_set(self, chan, value, timestamp=None):
        ...
        if value is None:
            self.logger.error(
                ...
                f"representing a float. See https://aot-inc.github.io/AoT-AI/Error-Codes#error-100 for more info.")
            return
