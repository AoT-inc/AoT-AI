...
from aot-ai.config import ENABLE_FLASK_PROFILER
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="AoT-AI Flask HTTP server.")
    ...
    if args.ssl:
        ...
        cert = os.path.join(dir_path, "aot-ai_flask/ssl_certs/server.crt")
        privkey = os.path.join(dir_path, "aot-ai_flask/ssl_certs/server.key")
