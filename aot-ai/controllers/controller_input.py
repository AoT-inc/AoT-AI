...
from aot-ai.databases.models import (SMTP, Conversion,
...
from aot-ai.utils.inputs import parse_input_information, parse_measurement
...
class InputController(AbstractController, threading.Thread):
    ...
    def update_measure(self):
        ...
        try:
            ...
            self.logger.error(
                "AoT-AI is attempting to acquire measurement(s) from an Input that has already critically errored. "
