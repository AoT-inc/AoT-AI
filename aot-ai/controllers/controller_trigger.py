...
from aot-ai.utils.actions import trigger_controller_actions
from aot-ai.utils.database import db_retrieve_table_daemon
from aot-ai.utils.method import load_method_handler, parse_db_time
from aot-ai.utils.sunriseset import suntime_calculate_next_sunrise_sunset_epoch
from aot-ai.utils.system_pi import epoch_of_next_time
from aot-ai.utils.system_pi import time_between_range
    ...
    def start_method(self, method_id):
        ...
        if method_id:
            ...
            if parse_db_time(this_controller.method_start_time) is None:
                ...
                with session_scope(AOT-AI_DB_PATH) as db_session:
