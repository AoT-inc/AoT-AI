# -*- coding: utf-8 -*-
#
#  config_translations.py - AoT-AI phrases for translation
#
...
TRANSLATIONS = {
    ...
    'shutdown_value': {
        ...
        'phrase': lazy_gettext('The output value to set when AoT-AI shuts down')},
    'start_offset': {
    ...
    'startup_value': {
        ...
        'phrase': lazy_gettext('The output value to set when AoT-AI starts up')},
    'state_shutdown': {
        'title': lazy_gettext('Shutdown State'),
        'phrase': lazy_gettext('When AoT-AI shuts down, set the output state')},
    'state_startup': {
        'title': lazy_gettext('Startup State'),
        'phrase': lazy_gettext('When AoT-AI starts, set the output state')},
    'switch_edge': {
        'title': lazy_gettext('Edge'),
    ...
    'trigger_functions_at_start': {
        ...
        'phrase': lazy_gettext('Whether or not to trigger Functions when AoT-AI starts')},
    'uart_location': {
