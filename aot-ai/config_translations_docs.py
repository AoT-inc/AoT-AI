# -*- coding: utf-8 -*-
#
#  config_translations_docs.py - AoT-AI Docs phrases for translation
#
...
TRANSLATIONS = {
    "index.md": {
        'AoT-AI Environmental Monitoring and Regulation System': lazy_gettext('AoT-AI Environmental Monitoring and Regulation System'),
        'text_1_1': lazy_gettext('AoT-AI is open source software designed to run on the [Raspberry Pi](https://en.wikipedia.org/wiki/Raspberry_Pi) and other single-board computers (SBCs). It couples inputs and outputs in interesting ways to sense and manipulate the environment.'),

        'Information': lazy_gettext('Information'),
        'text_2_1': lazy_gettext('See the [README](https://github.com/aot-inc/AoT-AI#uses) for features, projects using AoT-AI, screenshots, and other information.'),
        ...
        'text_4_1': lazy_gettext('Once booted and logged in, run the following command to initiate the AoT-AI install:'),
    ...
    "About.md": {
        "text_1_1": lazy_gettext("AoT-AI is an open-source environmental monitoring and regulation system that was built to run on single-board computers, specifically the [Raspberry Pi](https://en.wikipedia.org/wiki/Raspberry_Pi)."),
        ...
        "text_1_3": lazy_gettext("There are a number of different uses for AoT-AI. Some users simply store sensor measurements to monitor conditions remotely, others regulate the environmental conditions of a physical space, while others capture motion-activated or time-lapse photography, among other uses."),
        ...
        "text_1_8": lazy_gettext("AoT-AI has been translated to several languages. By default, the language of the browser will determine which language is used, but may be overridden in the General Settings, on the `[Gear Icon] -> Configure -> General` page. If you find an issue and would like to correct a translation or would like to add another language, this can be done at [https://translate.aot-inc.com](https://translate.aot-inc.com/engage/aot-ai/).")
    },
    ...
    "Data-Viewing.md": {
        ...
        "text_5_1": lazy_gettext("There is a Custom Widget import system in AoT-AI that allows user-created Widgets to be used in the AoT-AI system. Custom Widgets can be uploaded on the `[Gear Icon] -> Configure -> Custom Widgets` page. After import, they will be available to use on the `Setup -> Widget` page."),
        ...
        "text_5_3": lazy_gettext("Open any of the built-in Widget modules located in the directory [AoT-AI/aot-ai/widgets](https://github.com/aot-inc/AoT-AI/tree/master/aot-ai/widgets/) for examples of the proper formatting. There are also example Custom Widgets in the directory [AoT-AI/aot-ai/widgets/examples](https://github.com/aot-inc/AoT-AI/tree/master/aot-ai/widgets/examples)."),
