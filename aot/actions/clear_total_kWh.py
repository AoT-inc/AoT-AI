...
ACTION_INFORMATION = {
    ...
    'name': lazy_gettext('Flow Meter: Clear Total (Kilowatt-hour)'),
    'library': None,
    'manufacturer': 'AoT',
...
class ActionModule(AbstractFunctionAction):
    """Clear the accumulated total kilowatt-hour reading for an energy meter Input.
    ...
    def run_action(self, dict_vars):
        """Invoke clear_total_kwh on the target energy meter Input."""
        try:
