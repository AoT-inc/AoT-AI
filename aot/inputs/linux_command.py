...
class InputModule(AbstractInput):
    """Shell command executor that captures and stores command output as a numeric measurement.

    Executes a user-defined Bash command and stores the output as a float value.
