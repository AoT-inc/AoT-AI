...
class InputModule(AbstractInput):
    """Reads temperature, humidity, pressure, battery, and acceleration from RuuviTag BLE sensor.
    ...
    def get_measurement(self):
        ...
        if lf.lock_acquire(self.lock_file, timeout=3600):
            ...
            try:
                cmd = 'timeout -k 11 10 /opt/AoT/env/bin/python ' \
                      '/opt/AoT/aot/inputs/scripts/ruuvitag_values.py ' \
