...
try:
    from mcp_config import DEVICE_IPS as _DEVICE_IPS
except ImportError:
    import os as _os
    _DEVICE_IPS = {'th1x_am2301': _os.getenv('DEVICE_IP_TH1X_AM2301', '192.168.0.100')}
    ...
    'custom_options': [
        {
            'id': 'ip_address',
            'type': 'text',
            'default_value': _DEVICE_IPS.get('th1x_am2301', '192.168.0.100'),
            'required': True,
...
class InputModule(AbstractInput):
    """Queries Sonoff TH16/10 with AM2301 sensor for temperature and humidity."""
