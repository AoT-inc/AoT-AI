...
class InputModule(AbstractInput):
    """Retrieves weather data (temperature, humidity, pressure, wind) for a latitude/longitude from OpenWeatherMap API.
    ...
    def get_measurement(self):
        ...
        if not self.api_url:
            self.logger.error("API Key and Coords required")
            return
