...
try:
    ...
    import os as _os
    _DEVICE_IPS = {'th1x_ds18b20': _os.getenv('DEVICE_IP_TH1X_DS18B20', '192.168.0.100')}
    ...
    'custom_options': [
        {
            'id': 'ip_address',
            'type': 'text',
            'default_value': _DEVICE_IPS.get('th1x_ds18b20', '192.168.0.100'),
            'required': True,
...
class InputModule(AbstractInput):
    """Queries Sonoff TH16/10 with DS18B20 sensor for temperature."""
