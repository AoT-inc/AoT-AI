...
INPUT_INFORMATION = {
    ...
    'input_library': 'wiringpi, aot-inc/PiPyADC-py3',
...
class InputModule(AbstractInput):
    """Interfaces with the Texas Instruments ADS1256 ADC to measure pH and electrical conductivity from analog sensors.
