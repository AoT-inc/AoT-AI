...
logger = logging.getLogger("aot.utils.widget_generate_html")
    ...
    for widget_name in dict_widgets:
        try:
            ...
            with open(path_head, 'w') as fw:
                ...
                fw.write(html_head)
                fw.close()
            set_user_grp(path_head, 'aot', 'aot')
            ...
            with open(path_title_bar, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_title_bar, 'aot', 'aot')
            ...
            with open(path_body, 'w') as fw:
                ...
                fw.write(html_body)
                fw.close()
            set_user_grp(path_body, 'aot', 'aot')
            ...
            with open(path_configure_options, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_configure_options, 'aot', 'aot')
            ...
            with open(path_js_ready, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_js_ready, 'aot', 'aot')
            ...
            with open(path_js_ready_end, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_js_ready_end, 'aot', 'aot')
