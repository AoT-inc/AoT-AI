...
from aot.config import (CAMERA_INFO, DEPENDENCIES_GENERAL,
...
logger = logging.getLogger("aot.update_dependencies")
    ...
    if dependencies:
        for each_dep in dependencies:
            ...
            if each_dep[2] == 'bash-commands':
                ...
                install_cmd = f"{INSTALL_DIRECTORY}/aot/scripts/dependencies.sh {each_dep[1]}"
