...
#
"""Drive a Grove I2C LCD with RGB backlight (16x2 character layout).
...
class LCD_Grove_LCD_RGB:
    """Drive a Grove I2C LCD RGB display with 16x2 character layout.
    ...
    def setRGB(self, r, g, b):
        """Set the RGB backlight color values."""
    ...
    def clearDisplay(self):
        """Clear all characters from the LCD display."""
    ...
    def setText(self, text):
        """Write a text string to the display, wrapping at line boundaries."""
        self.clearDisplay()
        self.setCursor(0, 0)
        count = 0
        row = 0
    ...
    def display_backlight_color(self, color_tuple):
        """Set backlight color from a comma-separated RGB string."""
        try:
    ...
    def lcd_write_lines(self, line_1, line_2, line_3, line_4):
        """Write up to four text lines to the LCD display."""
        msg = ""
