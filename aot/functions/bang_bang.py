...
class CustomModule(AbstractFunction):
    """Implement bang-bang hysteretic control for a single on/off output.

    Supports raise or lower direction with configurable setpoint
    and hysteresis band.
    ...
    def initialize(self):
        """Resolve the output channel and log startup configuration."""
    ...
    def loop(self):
        """Evaluate measurement and toggle output based on hysteresis band."""
    ...
    def stop_function(self):
        """Turn off the controlled output on deactivation."""
