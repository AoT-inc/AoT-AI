...
class CustomModule(AbstractFunction):
    """Sum the latest values from multiple measurement sources.

    Retrieves the most recent reading from each selected measurement
    and stores the total sum to InfluxDB.
    ...
    def loop(self):
        """Collect latest values from all sources and store their sum."""
