...
class CustomModule(AbstractFunction):
    """Display measurement values, timestamps, text, and IP addresses on a 128x64 SSD1306 OLED (4-line mode) via SPI.

    Cycles through configurable line sets every period, displaying selected measurements,
    current time, static text, or IP address on each of 4 lines. Supports custom fonts
    and per-line decimal precision settings.

    @phase display
    @stability stable
    @dependency AbstractFunction, DaemonControl, adafruit-circuitpython-ssd1306, adafruit-circuitpython-framebuf, Adafruit-GPIO, Adafruit-extended-bus, Pillow
    """
