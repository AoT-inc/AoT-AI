...
class CustomModule(AbstractFunction):
    """Compute statistics across the latest values of multiple measurements.

    Retrieves the most recent reading from each selected measurement
    source and calculates mean, median, min, max, and standard deviation.
    ...
    def loop(self):
        """Collect latest measurements and store computed statistics."""
