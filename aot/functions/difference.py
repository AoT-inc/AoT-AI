...
class CustomModule(AbstractFunction):
    """Calculate the difference between two measurement sources.

    Retrieves the latest values from two configured measurements, computes their
    difference (optionally reversed or absolute), and stores the result.
