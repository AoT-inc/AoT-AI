...
class CustomModule(AbstractFunction):
    """Evaluate a user-defined equation on a single measurement value.

    Replaces the variable x in a custom equation string with the latest
    reading from a selected measurement and stores the computed result.
