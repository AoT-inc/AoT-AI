...
from aot.utils.influx import sum_past_seconds
...
class CustomModule(AbstractFunction):
    """Sum past readings from a single measurement source.

    Retrieves all values within the configured max age window for one
    measurement and stores the total sum to InfluxDB.
    ...
    def loop(self):
        """Query past measurement values and store their sum."""
