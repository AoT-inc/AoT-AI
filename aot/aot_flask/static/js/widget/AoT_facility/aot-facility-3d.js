...
(function (global) {
  ...
  function _buildParametricScene(canvas, facility, runtime, W, H) {
    ...
    floorMesh.position.set(totalWidth/2, 0.03, length/2); ghGroup.add(floorMesh);
    ...
    vcEl.style.cssText='position:absolute;top:32px;right:8px;z-index:15;display:grid;grid-template-columns:repeat(3,28px);grid-auto-rows:28px;gap:2px';
