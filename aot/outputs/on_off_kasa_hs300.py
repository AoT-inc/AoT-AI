...
class OutputModule(AbstractOutput):
    """Control Kasa HS300 6-outlet WiFi power strip (deprecated old library).
    ...
    def initialize(self):
        """Connect to the HS300 strip and apply per-outlet startup states."""
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Turn a specific outlet of the HS300 strip on or off."""
