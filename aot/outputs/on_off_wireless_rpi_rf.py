...
OUTPUT_INFORMATION = {
    ...
    'message': 'This output uses a 315 or 433 MHz transmitter to turn wireless power outlets on or off. '
               'Run /opt/AoT/aot/devices/wireless_rpi_rf.py with a receiver to discover the codes '
...
class OutputModule(AbstractOutput):
    """Control wireless power outlets via 315/433 MHz RF transmitter.
    ...
    def initialize(self):
        """Set up the 433 MHz transmitter and apply startup state."""
        from aot.devices.wireless_rpi_rf import Transmit433MHz
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Transmit the on or off RF code to the wireless outlet."""
