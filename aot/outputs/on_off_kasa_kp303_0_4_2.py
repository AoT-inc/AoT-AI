...
class OutputModule(AbstractOutput):
    """Control Kasa KP303 3-outlet WiFi power strip via asyncio RPC.
    ...
    def initialize(self):
        """Start the asyncio RPC server, connect to the strip, and apply startup states."""
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Turn a specific outlet of the KP303 strip on or off via RPC."""
