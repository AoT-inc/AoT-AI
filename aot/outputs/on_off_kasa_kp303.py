...
class OutputModule(AbstractOutput):
    """Control Kasa KP303 3-outlet WiFi power strip (deprecated old library).
    ...
    def initialize(self):
        """Connect to the KP303 strip and apply per-outlet startup states."""
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Turn a specific outlet of the KP303 strip on or off."""
