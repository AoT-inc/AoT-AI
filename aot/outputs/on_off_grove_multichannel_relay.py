...
class OutputModule(AbstractOutput):
    """Control 4 or 8 relays on the Grove multichannel relay board via I2C.
    ...
    def initialize(self):
        """Set up the Grove multichannel relay board over I2C and apply startup states."""
        import smbus2
...
class GroveMultiRelay(object):
    """Drive the Grove multichannel relay board via bitmask I2C writes.
