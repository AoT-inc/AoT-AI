...
class OutputModule(AbstractOutput):
    """Control WS2812 NeoPixel RGB LED strips via Raspberry Pi GPIO PWM.
    ...
    def initialize(self):
        """Configure the NeoPixel GPIO strip and run startup color sequence."""
        import board
        import neopixel
    ...
    def output_switch(self, state, output_type=None, amount=None, duty_cycle=None, output_channel=None):
        """Set all LEDs to the configured color/rainbow or turn them off."""
