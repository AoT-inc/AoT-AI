...
class OutputModule(AbstractOutput):
    """Drive PWM output via PCA9685 16-channel I2C PWM controller.

    @phase active
    @stability stable
    @dependency AbstractOutput, Adafruit_PCA9685
    """
    ...
    def initialize(self):
        """Configure PCA9685 over I2C and apply per-channel startup states."""
    ...
    def output_switch(self, state, output_type=None, amount=0, output_channel=None):
        """Set duty cycle on a specific PCA9685 channel (0-15)."""
