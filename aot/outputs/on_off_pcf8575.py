...
class OutputModule(AbstractOutput):
    """Control 16-channel on/off output via PCF8575 I2C IO expander.
    ...
    def initialize(self):
        """Open I2C bus, instantiate PCF8575 device, and set all 16 channel startup states."""
        import smbus2
    ...
    def output_switch(self,
                      ...
                      duty_cycle=None,
                      output_channel=None):
        """Set a single channel on or off via the PCF8575 I2C expander."""
...
class PCF8575(object):
    """I2C driver for the PCF8575 16-bit IO expander chip.
