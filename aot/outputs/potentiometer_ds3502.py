...
class OutputModule(AbstractOutput):
    """Control the DS3502 digital potentiometer to produce a 0-10k Ohm resistance.

    @phase active
    @stability stable
    @dependency AbstractOutput, adafruit-circuitpython-ds3502, Adafruit_Extended_Bus
    """
