...
class OutputModule(AbstractOutput):
    """Control TP-Link Kasa WiFi RGB light bulbs with HSV and color temp.
    ...
    def initialize(self):
        """Start the asyncio RPC server, connect to the bulb, and apply startup state."""
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Turn the Kasa RGB bulb on or off via RPC."""
