...
class OutputModule(AbstractOutput):
    """Drive PWM output via Raspberry Pi GPIO using the RPi.GPIO library.
    ...
    def initialize(self):
        """Configure RPi.GPIO software PWM and apply startup duty cycle state."""
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Set PWM duty cycle via RPi.GPIO ChangeDutyCycle."""
