...
OUTPUT_INFORMATION = {
    ...
    'output_name': "{} AoT Output: {}".format(lazy_gettext('Remote'), lazy_gettext('PWM')),
    'measurements_dict': measurements_dict,
    'channels_dict': channels_dict,
    'output_library': 'requests',
    'output_types': ['pwm'],

    'message': 'This Output allows remote control of another AoT PWM Output over a network using the API.',
...
class OutputModule(AbstractOutput):
    """Control another AoT PWM output over a network via the AoT REST API.
