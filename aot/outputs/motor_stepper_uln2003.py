...
class OutputModule(AbstractOutput):
    """Control a unipolar stepper motor via the ULN2003 driver board.

    @phase active
    @stability stable
    @dependency AbstractOutput, RpiMotorLib
    """
    ...
    def initialize(self):
        """Set up the 4 GPIO pins and instantiate the RpiMotorLib BYJ driver."""
