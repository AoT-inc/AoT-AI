...
from aot-ai.config import ALEMBIC_UPGRADE_POST
...
def upgrade_revision(error, revision):
    ...
    #     pass  # Code goes here
        ...
        try:
            with session_scope(AOT-AI_DB_PATH) as session:
        ...
        try:
            ...
            command = f'/bin/bash {INSTALL_DIRECTORY}/aot-ai/scripts/upgrade_commands.sh setup-virtualenv-full'
        ...
        from aot-ai.databases.models import Conditional
        ...
        import json
        from aot-ai.databases.models import Actions
        from aot-ai.databases.models import Camera
        from aot-ai.databases.models import ConditionalConditions
        from aot-ai.databases.models import DeviceMeasurements
        from aot-ai.databases.models import Input
        from aot-ai.databases.models import Math
        from aot-ai.databases.models import Output
        from aot-ai.databases.models import OutputChannel
        from aot-ai.databases.models import PID
        from aot-ai.databases.models import Trigger
        ...
        from aot-ai.databases.models import DeviceMeasurements
        from aot-ai.databases.models import LCD
        from aot-ai.databases.models import Output
        ...
        from aot-ai.databases.models import ConditionalConditions
        from aot-ai.databases.models import Conditional
        from aot-ai.utils.conditional import save_conditional_code
        ...
        from aot-ai.databases.models import ConditionalConditions
        from aot-ai.databases.models import Input
        from aot-ai.inputs.python_code import execute_at_creation
        from aot-ai.utils.conditional import save_conditional_code
