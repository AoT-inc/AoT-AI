#!/bin/bash
#
#  setup_unattended.sh - AoT-AI install script (unattended version)
#
#  Usage: sudo /bin/bash /opt/AoT-AI/install/setup_unattended.sh [influx-option]
...
case "${1:-''}" in
    '1')
        printf "#### Installing AoT-AI with Influxdb 1.x\n"
    ;;
    '2')
        printf "#### Installing AoT-AI with Influxdb 2.x\n"
    ;;
    '0')
        printf "#### Installing AoT-AI without installing Influxdb\n"
    ;;
    *)
