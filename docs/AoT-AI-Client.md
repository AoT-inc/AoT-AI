The AoT-AI client is a command-line tool used to communicate with the daemon.

```console
pi@raspberry:~ $ aot-ai-client --help
usage: aot-ai-client [-h] [-c] [--activatecontroller CONTROLLER ID]
...
optional arguments:
  ...
  --deactivatecontroller CONTROLLER ID
                        ...
                        PID, Input
  --ramuse              Return the amount of ram used by the AoT-AI daemon
