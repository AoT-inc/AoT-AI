...
If you are installing via Docker, you will need to change the hostname to "aot-ai_influxdb" after the AoT-AI install to be able to connect to the InfluxDB Docker container.
