description: Documentation for AoT-AI, an open source environmental monitoring and regulation system.

## AoT-AI Environmental Monitoring and Regulation System

AoT-AI is open source software designed to run on the [Raspberry Pi](https://en.wikipedia.org/wiki/Raspberry_Pi) and other single-board computers (SBCs). It couples inputs and outputs in interesting ways to sense and manipulate the environment.

### Information

See the [README](https://github.com/kizniche/AoT-AI#uses) for features, projects using AoT-AI, screenshots, and other information.
...
Once booted and logged in, run the following command to initiate the AoT-AI install:
...
*   [Frequently Asked Questions](https://forum.radicaldiy.com/docs?category=23&tags=aot-ai)
