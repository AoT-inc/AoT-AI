...
if aot_local_dir and os.path.exists(os.path.join(aot_local_dir, 'databases')):
...
PATH_JS_USER = os.path.join(INSTALL_DIRECTORY, 'aot/aot_flask/static/js/user_js')
...
STATS_PASSWORD = os.getenv('AOT_NAS_SECRET', 'Io8Nasr5JJDdhPOj32222')
