...
try:
    ...
    import os as _os
    _DEVICE_IPS = {'th1x': _os.getenv('DEVICE_IP_TH1X', '192.168.0.100')}
    ...
    'custom_options': [
        {
            'id': 'ip_address',
            'type': 'text',
            'default_value': _DEVICE_IPS.get('th1x', '192.168.0.100'),
            'required': True,
...
class InputModule(AbstractInput):
    """Queries Sonoff TH16/10 with AM2301/Si7021 for temperature and humidity."""
