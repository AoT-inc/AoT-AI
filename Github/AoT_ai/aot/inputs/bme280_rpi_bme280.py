...
class InputModule(AbstractInput):
    """
    Sensor driver for the BOSCH BME280 temperature/humidity/pressure sensor.

    Reads temperature, humidity, pressure, and calculates dewpoint, altitude, and vapor pressure deficit.
