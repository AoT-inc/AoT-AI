...
class InputModule(AbstractInput):
    """
    Sensor driver for the AMS CCS811 VOC/CO2 gas sensor with temperature compensation.

    Reads equivalent CO2 concentration (eCO2), total volatile organic compounds (TVOC), and temperature.
