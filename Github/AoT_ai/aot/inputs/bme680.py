...
from aot.inputs.sensorutils import calculate_altitude
...
class InputModule(AbstractInput):
    """
    Sensor driver for the BOSCH BME680 temperature/humidity/pressure/gas sensor.

    Reads temperature, humidity, pressure, gas resistance, and calculates dewpoint, altitude, and vapor pressure deficit.
