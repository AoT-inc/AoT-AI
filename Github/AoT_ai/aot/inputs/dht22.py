...
class InputModule(AbstractInput):
    """
    Sensor driver for the AOSONG DHT22 (AM2302) temperature/humidity sensor.

    Reads relative humidity and temperature, and calculates dewpoint and vapor pressure deficit.
