...
try:
    ...
    import os as _os
    _DEVICE_IPS = {'tasmota': _os.getenv('DEVICE_IP_TASMOTA', '192.168.0.50')}
    ...
    'custom_options': [
        {
            'id': 'host',
            'type': 'text',
            'default_value': _DEVICE_IPS.get('tasmota', '192.168.0.50'),
            'required': True,
...
class InputModule(AbstractInput):
    """Queries a Tasmota WiFi outlet for voltage, current, power, and energy measurements."""
