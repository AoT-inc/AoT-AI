...
class InputModule(AbstractInput):
    """Senseair K96 UART multi-gas sensor module.

    Produces methane, humidity, CO2, pressure (hPa), temperature (C),
    calculated dew point (C), altitude (m), and vapor pressure deficit (Pa).
