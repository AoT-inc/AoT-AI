class AoTGeoPanel {
    ...
    _bindNavEvents(rootEl = this.viewport) {
        ...
        if (btnHideSp) btnHideSp.onclick = () => {
            ...
            this._handleGeometryOp('hide-sprinkler-points', null, !this.isSprinklerPointsHidden);
            this.render();
        };
        ...
        if (btnHideConn) btnHideConn.onclick = () => {
            ...
            this._handleGeometryOp('hide-connection-points', null, !this.isConnectionPointsHidden);
            this.render();
        };
