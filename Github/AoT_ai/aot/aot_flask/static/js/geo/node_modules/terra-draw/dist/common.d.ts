...
export declare const FinishActions: {
    readonly Draw: "draw";
    readonly Edit: "edit";
    readonly DeleteCoordinate: "deleteCoordinate";
    readonly InsertMidpoint: "insertMidpoint";
    readonly DragCoordinate: "dragCoordinate";
    readonly DragFeature: "dragFeature";
    readonly DragCoordinateResize: "dragCoordinateResize";
};
export type DrawInteractions = "click-move" | "click-drag" | "click-move-or-drag";
...
export type TerraDrawHandledEvents = Extract<keyof HTMLElementEventMap, "pointerdown" | "pointerup" | "pointermove" | "contextmenu" | "keyup" | "keydown">;
...
declare const GUIDANCE_POINT_PROPERTY_KEYS: ("midPoint" | "selectionPoint" | "edited" | "closingPoint" | "snappingPoint" | "coordinatePoint")[];
export type GuidancePointProperties = (typeof GUIDANCE_POINT_PROPERTY_KEYS)[number];
/**
