...
from aot.config import ID_FILE
from aot.config import INSTALL_DIRECTORY
from aot.config import AOT_VERSION
from aot.config import STATS_CSV
from aot.config import STATS_DATABASE
from aot.config import STATS_HOST
from aot.config import STATS_PASSWORD
from aot.config import STATS_PORT
from aot.config import STATS_USER
from aot.databases.models import Actions
from aot.databases.models import AlembicVersion
...
logger = logging.getLogger("aot.stats")
...
def send_anonymous_stats(start_time):
    ...
    try:
        ...
        add_update_csv(STATS_CSV, 'AoT_revision', AOT_VERSION)
