...
def generate_controller_doc(out_file, each_data):
    """Write shared controller documentation block to a markdown file.

    Renders dependencies, URLs, messages, usage notes, and an HTML options
    table for a single controller entry.

    @phase doc-generation
    @dependency aot.config_translations
    """
