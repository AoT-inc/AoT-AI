...
TRANSLATIONS = {
    ...
    'shutdown_value': {
        ...
        'phrase': lazy_gettext('The output value to set when AoT shuts down')},
    'start_offset': {
    ...
    'startup_value': {
        ...
        'phrase': lazy_gettext('The output value to set when AoT starts up')},
    'state_shutdown': {
        'title': lazy_gettext('Shutdown State'),
        'phrase': lazy_gettext('When AoT shuts down, set the output state')},
    'state_startup': {
        'title': lazy_gettext('Startup State'),
        'phrase': lazy_gettext('When AoT starts, set the output state')},
    'switch_edge': {
        'title': lazy_gettext('Edge'),
    ...
    'trigger_functions_at_start': {
        ...
        'phrase': lazy_gettext('Whether or not to trigger Functions when AoT starts')},
    'uart_location': {
