...
class OutputModule(AbstractOutput):
    """Control a peristaltic pump via Raspberry Pi GPIO pin (Pi <= 4).
    ...
    def initialize(self):
        """Set up GPIO pin as output and configure initial off state."""
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Route pump on/off/volume/duration commands to the appropriate handler."""
