...
class OutputModule(AbstractOutput):
    """Control 16 on/off channels via XL9535 I2C I/O expander.

    @phase active
    @stability stable
    @dependency AbstractOutput, XL9535, smbus2
    """
    ...
    def initialize(self):
        """Set up the XL9535 over I2C and apply startup states to all 16 channels."""
        import smbus2
    ...
    def output_switch(self,
                      ...
                      duty_cycle=None,
                      output_channel=None):
        """Set the specified XL9535 channel on or off."""
...
class XL9535(object):
    """Manage register-level I2C communication for the XL9535 16-channel I/O expander.
