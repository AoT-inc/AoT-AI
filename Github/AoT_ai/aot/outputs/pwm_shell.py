...
class OutputModule(AbstractOutput):
    """Drive PWM output by executing shell commands via subprocess.
    ...
    def initialize(self):
        """Validate shell command configuration and apply startup state."""
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Execute shell command with duty cycle substituted for ((duty_cycle))."""
