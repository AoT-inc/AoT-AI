...
class OutputModule(AbstractOutput):
    """Control peristaltic pumps via MCP23017 16-channel I2C IO expander.

    @phase active
    @stability stable
    @dependency AbstractOutput, adafruit-circuitpython-mcp230xx
    """
    ...
    def initialize(self):
        """Set up MCP23017 I2C device and configure all 16 output pins."""
    ...
    def turn_on_off(self, switch_channel, state):
        """Toggle a single MCP23017 channel on or off with lock protection."""
        msg = ""
        lf = LockFile()
