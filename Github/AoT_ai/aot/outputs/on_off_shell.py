...
class OutputModule(AbstractOutput):
    """Execute shell commands as a configurable Linux user for on/off switching.

    @phase active
    @stability stable
    @dependency AbstractOutput, subprocess
    """
    ...
    def initialize(self):
        """Validate on/off commands and apply the configured startup state."""
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Run the configured shell command for the requested on or off state."""
