...
class OutputModule(AbstractOutput):
    """Control 16 on/off channels via MCP23017 I2C I/O expander.
    ...
    def initialize(self):
        """Set up the MCP23017 over I2C and configure all 16 channel startup states."""
    ...
    def output_switch(self,
                      ...
                      duty_cycle=None,
                      output_channel=None):
        """Set the specified MCP23017 channel on or off."""
