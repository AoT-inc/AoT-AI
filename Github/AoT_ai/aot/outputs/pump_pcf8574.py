...
class OutputModule(AbstractOutput):
    """Control peristaltic pumps via PCF8574 8-channel I2C IO expander.

    @phase active
    @stability stable
    @dependency AbstractOutput, smbus2
    """
    ...
    def initialize(self):
        """Set up PCF8574 I2C device and configure all 8 output channels."""
        import smbus2
    ...
    def turn_on_off(self, switch_channel, state):
        """Toggle a single PCF8574 channel while preserving other channel states."""
        msg = ""
        lf = LockFile()
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Route pump on/off/volume/duration commands per expander channel."""
    ...
    def dict_to_list_states(dict_states):
        """Convert channel state dict to ordered list for PCF8574 port write."""
        list_states = []
