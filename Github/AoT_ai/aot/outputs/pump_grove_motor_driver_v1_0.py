...
class OutputModule(AbstractOutput):
    """Control peristaltic pumps via Grove I2C Motor Driver (TB6612FNG, v1.0).
    ...
    def initialize(self):
        """Set up I2C bus connection to the Grove TB6612FNG motor driver."""
        import smbus2
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Route pump on/off/volume/duration commands via I2C register writes."""
    ...
    def set_i2c_address(self, args_dict):
        """Change the I2C address of the Grove motor driver board."""
