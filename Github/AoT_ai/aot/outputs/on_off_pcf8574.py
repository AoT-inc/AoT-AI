...
class OutputModule(AbstractOutput):
    """Control 8-channel on/off output via PCF8574 I2C IO expander.
    ...
    def initialize(self):
        """Open I2C bus, instantiate PCF8574 device, and set all 8 channel startup states."""
        import smbus2
    ...
    def output_switch(self,
                      ...
                      duty_cycle=None,
                      output_channel=None):
        """Set a single channel on or off while preserving other channel states."""
...
class PCF8574(object):
    """I2C driver for the PCF8574 8-bit IO expander chip.
