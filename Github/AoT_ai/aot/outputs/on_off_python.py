...
def generate_code(code_on, code_off, unique_id):
    """Generate a Python module file containing user on/off code wrapped in OutputRun class.
...
def execute_at_modification(
    ...
    """Validate user Python code with pylint when the output configuration is saved.
...
class OutputModule(AbstractOutput):
    """Execute user-supplied Python code for on/off switching.
    ...
    def initialize(self):
        """Compile user Python code into a loadable module and apply startup state."""
    ...
    def output_switch(self, state, output_type=None, amount=None, output_channel=None):
        """Invoke the user-defined on or off Python code method."""
