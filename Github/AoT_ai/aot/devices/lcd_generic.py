# coding=utf-8
"""Drive a generic I2C-backpacked character LCD (16x2 or 20x4).
...
logger = logging.getLogger("aot.device.lcd_generic")


class LCD_Generic:
    """Drive a generic I2C LCD with 16x2 or 20x4 character layout.
