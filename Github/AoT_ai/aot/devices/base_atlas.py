# coding=utf-8
"""Define abstract base class for all Atlas Scientific sensor drivers.
...
class AbstractBaseAtlasScientific(object):
    """Provide abstract base for Atlas Scientific sensor controllers.

    Ensure that subclasses implement required methods and carry
    standard instance variables for board identification.
    ...
    def query(self, query_str):
        """Send a query string to the sensor and return the response."""
        self.logger.error(
