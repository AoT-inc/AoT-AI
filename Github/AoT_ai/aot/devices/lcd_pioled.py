# coding=utf-8
"""Drive a PiOLED SSD1306-based OLED display via Adafruit legacy library.

@phase active
@stability stable
@dependency Adafruit_SSD1306, PIL
"""
import logging
import time
...
logger = logging.getLogger("aot.device.lcd_pioled")


class LCD_Pioled:
    """Drive a PiOLED SSD1306 OLED display over I2C or SPI.
