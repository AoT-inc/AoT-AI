...
ACTION_INFORMATION = {
    ...
    'name': lazy_gettext('LED: Neopixel: Flashing Off'),
    'library': None,
    'manufacturer': 'AoT',
...
class ActionModule(AbstractFunctionAction):
    """Stop flashing a specific pixel in a Neopixel LED strip.
    ...
    def run_action(self, dict_vars):
        """Send a flashing-off command for the specified LED position."""
