...
class ActionModule(AbstractFunctionAction):
    """Demonstrate a function-based action with various custom option types.
    ...
    def run_action(self, dict_vars):
        """Perform an example epoch-time calculation using custom options."""
        try:
        ...
        # Logs can be viewed at Config -> AoT Logs -> Damon Log.
        self.logger.info(
