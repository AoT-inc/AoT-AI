...
class ActionModule(AbstractFunctionAction):
    """Shut down the AoT system via wrapper script.
    ...
    def run_action(self, dict_vars):
        """Initiate a system shutdown with a 10-second delay."""
        dict_vars['message'] += " System shutting down in 10 seconds."
        cmd = f'{INSTALL_DIRECTORY}/aot/scripts/aot_wrapper shutdown 2>&1'
