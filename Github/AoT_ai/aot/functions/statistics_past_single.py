...
class CustomModule(AbstractFunction):
    """Compute statistics from past readings of a single measurement.

    Retrieves all values within the configured max age window for one
    measurement source and calculates mean, median, min, max, and
    standard deviation.
    ...
    def loop(self):
        """Retrieve past measurements and store computed statistics."""
