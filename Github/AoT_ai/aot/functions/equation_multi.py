...
class CustomModule(AbstractFunction):
    """Evaluate a user-defined equation on two measurement values.

    Replaces variables a and b in a custom equation string with the latest
    readings from two selected measurements and stores the computed result.
