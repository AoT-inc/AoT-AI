...
class CustomModule(AbstractFunction):
    """Calculate humidity and related psychrometric properties from wet and dry bulb temperatures.

    Uses dry bulb and wet bulb temperature readings (and optionally pressure) to compute
    relative humidity, humidity ratio, specific enthalpy, and specific volume via
    the SI psychrometric library.
