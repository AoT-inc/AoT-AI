...
class CustomModule(AbstractFunction):
    """Example template function demonstrating multiple measurement channels.

    This reference implementation shows how to create a function with a
    variable number of measurement channels and per-channel custom options.
    Developers should copy this file as a starting point for multi-channel functions.

    @phase prototype
    @stability experimental
    @dependency AbstractFunction, DaemonControl, Conversion, FunctionChannel
    """
