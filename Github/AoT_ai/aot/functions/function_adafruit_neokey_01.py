...
class CustomModule(AbstractFunction):
    """Adafruit NeoKey 4x1 USB button board with RGB status LED and action execution.

    Polls four mechanical keys on the I2C NeoKey board and triggers configured
    AoT actions on press. Supports LED state feedback, toggle mode, and
    per-key color customization.

    @phase co-growth
    @stability experimental
    @dependency AbstractFunction, DaemonControl, Actions
    """
