...
class CustomModule(AbstractFunction):
    """Return the first available measurement from a prioritized list of sources.

    Checks up to three measurement sources in order (A, then B, then C) and stores
    the value from whichever is available and within its max age. Supports
    cascading multiple redundancy functions for more sources.
