#!/bin/bash
#
#  setup_unattended.sh - AoT install script (unattended version)
#
#  Usage: sudo /bin/bash /opt/AoT/install/setup_unattended.sh [influx-option]
...
case "${1:-''}" in
    '1')
        printf "#### Installing AoT with Influxdb 1.x\n"
    ;;
    '2')
        printf "#### Installing AoT with Influxdb 2.x\n"
    ;;
    '0')
        printf "#### Installing AoT without installing Influxdb\n"
    ;;
    *)
